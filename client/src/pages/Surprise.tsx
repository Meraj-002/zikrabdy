...
export default function Surprise() {
  ...
  const surpriseText = `I don’t have a big gift to give you in person today…

But I made this just to remind you
how special you are to me.

From that one eye contact,
to every small moment after,
you slowly became my favorite person.
...
const text = "No distance can change what I feel for you.";
